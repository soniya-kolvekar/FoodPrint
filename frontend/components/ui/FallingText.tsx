...
const FallingText: React.FC<FallingTextProps> = ({
  ...
  useEffect(() => {
    ...
    const wordSpans = textRef.current.querySelectorAll('.fall-item, span');
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-[1] w-full h-full cursor-pointer text-left overflow-hidden"
