...
export function MagicCard(props: MagicCardProps) {
  const {
    ...
    className,
    gradientSize = 200,
    gradientColor = "rgba(69, 9, 32, 0.05)",
    gradientOpacity = 0.8,
    gradientFrom = "#da627d",
    gradientTo = "#450920",
    mode = "gradient",
  ...
  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "#da627d") : "#da627d"
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "#450920") : "#450920"
      ...
      style={{
        background: useMotionTemplate`
          ...
          radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
            ${gradientFrom},
            ${gradientTo},
            var(--color-border, rgba(69, 9, 32, 0.1)) 100%
          ) border-box
        `,
      }}
    >
